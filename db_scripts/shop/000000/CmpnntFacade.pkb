create or replace package body CmpnntFacade is
    ...
    begin
        select base.Cls into currentClass from Cmpnnt base, Specialization spec
             where base.id = CmpnntId and base.Cls = spec.descendant and spec.ancestor = 131;
    exception
        when no_data_found then
            raise_application_error(-20000, 'Object not of right class! Required specialization of: 131 Actual: ' || currentClass);
    end chkSpecCmpnnt;
    ...
    begin 
        ...
        ClassFacade.checkHasAsDescendant(131, ThisCls);
