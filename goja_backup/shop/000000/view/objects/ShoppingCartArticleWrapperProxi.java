...
public class ShoppingCartArticleWrapperProxi extends ArticleWrapperProxi implements ShoppingCartArticleWrapperView{
    
    public ShoppingCartArticleWrapperProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public ShoppingCartArticleWrapperView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        ...
        ShoppingCartArticleWrapperView result$$ = new ShoppingCartArticleWrapper((ArticleView)article,(String)name, this.getId(), this.getClassId());
