...
public class OwnerServiceConnection extends ServiceConnection {

	public OwnerServiceConnection (String url, ExceptionAndEventHandler handler, ClientReporter reporter) throws MalformedURLException {
		super(url, handler, reporter);
	}

	public OwnerServiceView getOwnerServiceView(){
		return (OwnerServiceView)super.getServer();
	}

    public synchronized String ownerService_Menu_Filter(Anything anything) throws ModelException{
        try {
            ...
            java.util.HashMap<?,?> success = (java.util.HashMap<?,?>)this.execute(this.connectionName, "ownerService_Menu_Filter", parameters);
    ...
    public synchronized void changeArticleName(ArticleWrapperView article, String newName) throws ModelException{
        try {
            Vector<Object> parameters = new Vector<Object>();
            if (article == null){
                parameters.add(common.RPCConstantsAndServices.createFromClientNullProxiRepresentation());
    ...
    public synchronized void changeArticleProducerDeliveryTime(ArticleWrapperView article, long newValue) throws ModelException, InvalidInputException{
        try {
            ...
            parameters.add(new Long(newValue).toString());
            java.util.HashMap<?,?> success = (java.util.HashMap<?,?>)this.execute(this.connectionName, "changeArticleProducerDeliveryTime", parameters);
            if(!((Boolean)success.get(common.RPCConstantsAndServices.OKOrNotOKResultFieldName)).booleanValue()){
                if (((Integer)success.get(common.RPCConstantsAndServices.ErrorNumberFieldName)).intValue() == 0)
                    throw new ModelException((String)success.get(common.RPCConstantsAndServices.ExceptionMessageFieldName), ((Integer)success.get(common.RPCConstantsAndServices.ExceptionNumberFieldName)).intValue());
                if(((Integer)success.get(common.RPCConstantsAndServices.ErrorNumberFieldName)).intValue() == -453)
    ...
    public synchronized void changeCustomerDeliveryTimePrice(CustomerDeliveryTimeView customerDeliveryTime, common.Fraction newValue) throws ModelException, InvalidInputException{
        try {
            ...
            java.util.HashMap<?,?> success = (java.util.HashMap<?,?>)this.execute(this.connectionName, "changeCustomerDeliveryTimePrice", parameters);
            if(!((Boolean)success.get(common.RPCConstantsAndServices.OKOrNotOKResultFieldName)).booleanValue()){
                if (((Integer)success.get(common.RPCConstantsAndServices.ErrorNumberFieldName)).intValue() == 0)
                    throw new ModelException((String)success.get(common.RPCConstantsAndServices.ExceptionMessageFieldName), ((Integer)success.get(common.RPCConstantsAndServices.ExceptionNumberFieldName)).intValue());
                if(((Integer)success.get(common.RPCConstantsAndServices.ErrorNumberFieldName)).intValue() == -453)
    ...
    public synchronized void changeCustomerDeliveryTimeTime(CustomerDeliveryTimeView customerDeliveryTime, long newValue) throws ModelException, InvalidInputException{
        try {
            ...
            parameters.add(new Long(newValue).toString());
            java.util.HashMap<?,?> success = (java.util.HashMap<?,?>)this.execute(this.connectionName, "changeCustomerDeliveryTimeTime", parameters);
            if(!((Boolean)success.get(common.RPCConstantsAndServices.OKOrNotOKResultFieldName)).booleanValue()){
                if (((Integer)success.get(common.RPCConstantsAndServices.ErrorNumberFieldName)).intValue() == 0)
                    throw new ModelException((String)success.get(common.RPCConstantsAndServices.ExceptionMessageFieldName), ((Integer)success.get(common.RPCConstantsAndServices.ExceptionNumberFieldName)).intValue());
                if(((Integer)success.get(common.RPCConstantsAndServices.ErrorNumberFieldName)).intValue() == -453)
    ...
    @SuppressWarnings("unchecked")
    public synchronized void changeMaxStock(ArticleWrapperView article, long newValue) throws ModelException, InvalidInputException{
        try {
            Vector<Object> parameters = new Vector<Object>();
            if (article == null){
                parameters.add(common.RPCConstantsAndServices.createFromClientNullProxiRepresentation());
    ...
    @SuppressWarnings("unchecked")
    public synchronized void changeMinStock(ArticleWrapperView article, long newValue) throws ModelException, InvalidInputException{
        try {
            Vector<Object> parameters = new Vector<Object>();
            if (article == null){
                parameters.add(common.RPCConstantsAndServices.createFromClientNullProxiRepresentation());
    ...
    public synchronized void changeNewCustomerDefaultBalance(common.Fraction newValue) throws ModelException, InvalidInputException{
        try {
            Vector<Object> parameters = new Vector<Object>();
            parameters.add(newValue.toString());
            java.util.HashMap<?,?> success = (java.util.HashMap<?,?>)this.execute(this.connectionName, "changeNewCustomerDefaultBalance", parameters);
            if(!((Boolean)success.get(common.RPCConstantsAndServices.OKOrNotOKResultFieldName)).booleanValue()){
                if (((Integer)success.get(common.RPCConstantsAndServices.ErrorNumberFieldName)).intValue() == 0)
                    throw new ModelException((String)success.get(common.RPCConstantsAndServices.ExceptionMessageFieldName), ((Integer)success.get(common.RPCConstantsAndServices.ExceptionNumberFieldName)).intValue());
                if(((Integer)success.get(common.RPCConstantsAndServices.ErrorNumberFieldName)).intValue() == -453)
    ...
    public synchronized void changeNewCustomerDefaultLimit(common.Fraction newValue) throws ModelException, InvalidInputException{
        try {
            Vector<Object> parameters = new Vector<Object>();
            parameters.add(newValue.toString());
            java.util.HashMap<?,?> success = (java.util.HashMap<?,?>)this.execute(this.connectionName, "changeNewCustomerDefaultLimit", parameters);
            if(!((Boolean)success.get(common.RPCConstantsAndServices.OKOrNotOKResultFieldName)).booleanValue()){
                if (((Integer)success.get(common.RPCConstantsAndServices.ErrorNumberFieldName)).intValue() == 0)
                    throw new ModelException((String)success.get(common.RPCConstantsAndServices.ExceptionMessageFieldName), ((Integer)success.get(common.RPCConstantsAndServices.ExceptionNumberFieldName)).intValue());
                if(((Integer)success.get(common.RPCConstantsAndServices.ErrorNumberFieldName)).intValue() == -453)
    ...
    public synchronized void changeReturnPercentage(common.Fraction newValue) throws ModelException, InvalidInputException{
        try {
            Vector<Object> parameters = new Vector<Object>();
            parameters.add(newValue.toString());
            java.util.HashMap<?,?> success = (java.util.HashMap<?,?>)this.execute(this.connectionName, "changeReturnPercentage", parameters);
            if(!((Boolean)success.get(common.RPCConstantsAndServices.OKOrNotOKResultFieldName)).booleanValue()){
                if (((Integer)success.get(common.RPCConstantsAndServices.ErrorNumberFieldName)).intValue() == 0)
                    throw new ModelException((String)success.get(common.RPCConstantsAndServices.ExceptionMessageFieldName), ((Integer)success.get(common.RPCConstantsAndServices.ExceptionNumberFieldName)).intValue());
                if(((Integer)success.get(common.RPCConstantsAndServices.ErrorNumberFieldName)).intValue() == -453)
    ...
    public synchronized void createCustomerDeliveryTime(CustomerDeliveryTimeManagerView customerDeliveryTimeManager, String name, common.Fraction price, long time) throws ModelException, DoubleDefinitionException, InvalidInputException{
        try {
            ...
            java.util.HashMap<?,?> success = (java.util.HashMap<?,?>)this.execute(this.connectionName, "createCustomerDeliveryTime", parameters);
            if(!((Boolean)success.get(common.RPCConstantsAndServices.OKOrNotOKResultFieldName)).booleanValue()){
                if (((Integer)success.get(common.RPCConstantsAndServices.ErrorNumberFieldName)).intValue() == 0)
                    throw new ModelException((String)success.get(common.RPCConstantsAndServices.ExceptionMessageFieldName), ((Integer)success.get(common.RPCConstantsAndServices.ExceptionNumberFieldName)).intValue());
    ...
    @SuppressWarnings("unchecked")
    public synchronized ArticleView getArticle(ArticleWrapperView wrapper) throws ModelException{
        try {
            Vector<Object> parameters = new Vector<Object>();
            if (wrapper == null){
                parameters.add(common.RPCConstantsAndServices.createFromClientNullProxiRepresentation());
            ...
            java.util.HashMap<?,?> success = (java.util.HashMap<?,?>)this.execute(this.connectionName, "getArticle", parameters);
            if(!((Boolean)success.get(common.RPCConstantsAndServices.OKOrNotOKResultFieldName)).booleanValue()){
                if (((Integer)success.get(common.RPCConstantsAndServices.ErrorNumberFieldName)).intValue() == 0)
                    throw new ModelException((String)success.get(common.RPCConstantsAndServices.ExceptionMessageFieldName), ((Integer)success.get(common.RPCConstantsAndServices.ExceptionNumberFieldName)).intValue());
                throw new ModelException ("Fatal error (unknown exception code:" + (Integer)success.get(common.RPCConstantsAndServices.ErrorNumberFieldName) + ")",0);
                ...
                ArticleView result = (ArticleView) view.objects.ViewProxi.createProxi(proxiInformation, getHandler());
    ...
    public synchronized void increaseArticleStock(ArticleWrapperView article, long quantity) throws ModelException{
        try {
            Vector<Object> parameters = new Vector<Object>();
            if (article == null){
                parameters.add(common.RPCConstantsAndServices.createFromClientNullProxiRepresentation());
            ...
            java.util.HashMap<?,?> success = (java.util.HashMap<?,?>)this.execute(this.connectionName, "increaseArticleStock", parameters);
            if(!((Boolean)success.get(common.RPCConstantsAndServices.OKOrNotOKResultFieldName)).booleanValue()){
                if (((Integer)success.get(common.RPCConstantsAndServices.ErrorNumberFieldName)).intValue() == 0)
                    throw new ModelException((String)success.get(common.RPCConstantsAndServices.ExceptionMessageFieldName), ((Integer)success.get(common.RPCConstantsAndServices.ExceptionNumberFieldName)).intValue());
                throw new ModelException ("Fatal error (unknown exception code:" + (Integer)success.get(common.RPCConstantsAndServices.ErrorNumberFieldName) + ")",0);
    ...
    public synchronized void newArticle(ComponentContainer parent, String name, common.Fraction price, long minStock, long maxStock, long producerDeliveryTime, ProducerView producer) throws ModelException, DoubleDefinitionException, CycleException{
        try {
            ...
            parameters.add(new Long(producerDeliveryTime).toString());
            if (producer == null){
                parameters.add(common.RPCConstantsAndServices.createFromClientNullProxiRepresentation());
            } else {
                parameters.add(((view.objects.ViewProxi)producer).createProxiInformation());
            }
            java.util.HashMap<?,?> success = (java.util.HashMap<?,?>)this.execute(this.connectionName, "newArticle", parameters);
            if(!((Boolean)success.get(common.RPCConstantsAndServices.OKOrNotOKResultFieldName)).booleanValue()){
                if (((Integer)success.get(common.RPCConstantsAndServices.ErrorNumberFieldName)).intValue() == 0)
                    throw new ModelException((String)success.get(common.RPCConstantsAndServices.ExceptionMessageFieldName), ((Integer)success.get(common.RPCConstantsAndServices.ExceptionNumberFieldName)).intValue());
                if(((Integer)success.get(common.RPCConstantsAndServices.ErrorNumberFieldName)).intValue() == -275)
    ...
    public synchronized void newProductGroup(ComponentContainer parent, String name) throws ModelException, DoubleDefinitionException, CycleException{
        try {
            ...
            parameters.add(name);
            java.util.HashMap<?,?> success = (java.util.HashMap<?,?>)this.execute(this.connectionName, "newProductGroup", parameters);
            if(!((Boolean)success.get(common.RPCConstantsAndServices.OKOrNotOKResultFieldName)).booleanValue()){
                if (((Integer)success.get(common.RPCConstantsAndServices.ErrorNumberFieldName)).intValue() == 0)
                    throw new ModelException((String)success.get(common.RPCConstantsAndServices.ExceptionMessageFieldName), ((Integer)success.get(common.RPCConstantsAndServices.ExceptionNumberFieldName)).intValue());
                if(((Integer)success.get(common.RPCConstantsAndServices.ErrorNumberFieldName)).intValue() == -275)
    ...
    @SuppressWarnings("unchecked")
    public synchronized void reduceArticleStock(ArticleWrapperView article, long quantity) throws ModelException, NotEnoughStockException{
        try {
            Vector<Object> parameters = new Vector<Object>();
            if (article == null){
                parameters.add(common.RPCConstantsAndServices.createFromClientNullProxiRepresentation());
            ...
            parameters.add(new Long(quantity).toString());
            java.util.HashMap<?,?> success = (java.util.HashMap<?,?>)this.execute(this.connectionName, "reduceArticleStock", parameters);
            if(!((Boolean)success.get(common.RPCConstantsAndServices.OKOrNotOKResultFieldName)).booleanValue()){
                if (((Integer)success.get(common.RPCConstantsAndServices.ErrorNumberFieldName)).intValue() == 0)
                    throw new ModelException((String)success.get(common.RPCConstantsAndServices.ExceptionMessageFieldName), ((Integer)success.get(common.RPCConstantsAndServices.ExceptionNumberFieldName)).intValue());
    ...
    public synchronized void startSelling(ArticleWrapperView article) throws ModelException{
        try {
            Vector<Object> parameters = new Vector<Object>();
            if (article == null){
                parameters.add(common.RPCConstantsAndServices.createFromClientNullProxiRepresentation());
    ...
    public synchronized void stopSelling(ArticleWrapperView article) throws ModelException{
        try {
            Vector<Object> parameters = new Vector<Object>();
            if (article == null){
                parameters.add(common.RPCConstantsAndServices.createFromClientNullProxiRepresentation());
