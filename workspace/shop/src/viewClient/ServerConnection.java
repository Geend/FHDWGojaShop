...
public class ServerConnection extends ConnectionMaster {
    ...
    public synchronized void createArticle(ProductGroupView parent, String name, common.Fraction price, long minStock, long maxStock, long producerDeliveryTime, ProducerView producer) throws ModelException, CycleException{
        try {
            Vector<Object> parameters = new Vector<Object>();
            if (parent == null){
                parameters.add(common.RPCConstantsAndServices.createFromClientNullProxiRepresentation());
    ...
    @SuppressWarnings("unchecked")
    public synchronized void createProductGroup(ProductGroupView parent, String name) throws ModelException, CycleException{
        try {
            Vector<Object> parameters = new Vector<Object>();
            if (parent == null){
                parameters.add(common.RPCConstantsAndServices.createFromClientNullProxiRepresentation());
