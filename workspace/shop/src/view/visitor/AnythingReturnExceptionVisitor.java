...
public interface AnythingReturnExceptionVisitor<R, E extends view.UserException> extends ArticleStateReturnExceptionVisitor<R, E> ,ComponentReturnExceptionVisitor<R, E> ,ServiceReturnExceptionVisitor<R, E> {
