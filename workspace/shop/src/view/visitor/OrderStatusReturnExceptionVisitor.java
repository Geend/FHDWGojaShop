...
public interface OrderStatusReturnExceptionVisitor<R, E extends view.UserException> {
    ...
    public R handleCanceledOrderState(CanceledOrderStateView canceledOrderState) throws ModelException, E;
