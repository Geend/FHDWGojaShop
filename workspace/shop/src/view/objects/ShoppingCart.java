...
public class ShoppingCart extends ViewObject implements ShoppingCartView{
    
    protected java.util.Vector<ShoppingCartQuantifiedArticleView> articles;
    
    public ShoppingCart(java.util.Vector<ShoppingCartQuantifiedArticleView> articles,long id, long classId) {
