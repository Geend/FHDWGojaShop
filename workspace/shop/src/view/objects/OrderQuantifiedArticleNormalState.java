...
public class OrderQuantifiedArticleNormalState extends view.objects.OrderQuantifiedArticleState implements OrderQuantifiedArticleNormalStateView{
    
    
    public OrderQuantifiedArticleNormalState(long id, long classId) {
