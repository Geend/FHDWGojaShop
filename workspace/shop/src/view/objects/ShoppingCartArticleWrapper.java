...
public class ShoppingCartArticleWrapper extends view.objects.ArticleWrapper implements ShoppingCartArticleWrapperView{
    
    
    public ShoppingCartArticleWrapper(ArticleView article,String name,long id, long classId) {
