...
public class StandardArticleWrapper extends view.objects.ArticleWrapper implements StandardArticleWrapperView{
    
    protected String name;
    
    public StandardArticleWrapper(String name,long id, long classId) {
