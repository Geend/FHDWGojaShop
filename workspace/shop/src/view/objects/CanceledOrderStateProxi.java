...
public class CanceledOrderStateProxi extends OrderStatusProxi implements CanceledOrderStateView{
    
    public CanceledOrderStateProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public CanceledOrderStateView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        CanceledOrderStateView result$$ = new CanceledOrderState( this.getId(), this.getClassId());
