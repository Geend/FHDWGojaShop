...
public class NewCreatedProxi extends ArticleStateProxi implements NewCreatedView{
    
    public NewCreatedProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public NewCreatedView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        NewCreatedView result$$ = new NewCreated( this.getId(), this.getClassId());
