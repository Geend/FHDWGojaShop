...
public class ComponentLstProxi extends ViewProxi implements ComponentLstView{
    ...
    public ComponentLstView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        ...
        ComponentLstView result$$ = new ComponentLst(currentComponents, this.getId(), this.getClassId());
    ...
    public ViewObjectInTree getChild(int originalIndex) throws ModelException{
        ...
        if(index < this.getCurrentComponents().size()) return new CurrentComponentsComponentLstWrapper(this, originalIndex, (ViewRoot)this.getCurrentComponents().get(index));
    ...
    public java.util.Vector<ComponentView> getCurrentComponents()throws ModelException{
        return ((ComponentLst)this.getTheObject()).getCurrentComponents();
    }
    public void setCurrentComponents(java.util.Vector<ComponentView> newValue) throws ModelException {
        ((ComponentLst)this.getTheObject()).setCurrentComponents(newValue);
    }
