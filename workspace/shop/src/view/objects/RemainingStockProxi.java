...
public class RemainingStockProxi extends ArticleStateProxi implements RemainingStockView{
    
    public RemainingStockProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public RemainingStockView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        RemainingStockView result$$ = new RemainingStock( this.getId(), this.getClassId());
