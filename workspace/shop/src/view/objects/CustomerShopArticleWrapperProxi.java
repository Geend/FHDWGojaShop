...
public class CustomerShopArticleWrapperProxi extends ArticleWrapperProxi implements CustomerShopArticleWrapperView{
    
    public CustomerShopArticleWrapperProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public CustomerShopArticleWrapperView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        String name = (String)resultTable.get("name");
        common.Fraction price = common.Fraction.parse((String)resultTable.get("price"));
        CustomerShopArticleWrapperView result$$ = new CustomerShopArticleWrapper((String)name,(common.Fraction)price, this.getId(), this.getClassId());
    ...
    public String getName()throws ModelException{
        return ((CustomerShopArticleWrapper)this.getTheObject()).getName();
    }
    public common.Fraction getPrice()throws ModelException{
        return ((CustomerShopArticleWrapper)this.getTheObject()).getPrice();
    }
