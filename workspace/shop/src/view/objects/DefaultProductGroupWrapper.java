...
public class DefaultProductGroupWrapper extends view.objects.ProductGroupWrapper implements DefaultProductGroupWrapperView{
    
    protected String name;
    protected java.util.Vector<ComponentWrapperView> components;
    
    public DefaultProductGroupWrapper(String name,java.util.Vector<ComponentWrapperView> components,long id, long classId) {
