...
public class FinishedOrderStateProxi extends OrderStatusProxi implements FinishedOrderStateView{
    ...
    public FinishedOrderStateView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        FinishedOrderStateView result$$ = new FinishedOrderState( this.getId(), this.getClassId());
