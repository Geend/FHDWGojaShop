...
public class FinishedOrderProxi extends OrderStateProxi implements FinishedOrderView{
    
    public FinishedOrderProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public FinishedOrderView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        FinishedOrderView result$$ = new FinishedOrder( this.getId(), this.getClassId());
