...
public class InTransitOrderState extends view.objects.OrderStatus implements InTransitOrderStateView{
    
    protected long ticksLeft;
    
    public InTransitOrderState(long ticksLeft,long id, long classId) {
