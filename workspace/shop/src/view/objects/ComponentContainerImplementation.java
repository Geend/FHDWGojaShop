...
public class ComponentContainerImplementation extends ViewObject implements ComponentContainerImplementationView{
    
    protected java.util.Vector<ComponentView> components;
    
    public ComponentContainerImplementation(java.util.Vector<ComponentView> components,long id, long classId) {
