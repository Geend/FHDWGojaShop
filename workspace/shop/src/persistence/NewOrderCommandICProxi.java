...
public class NewOrderCommandICProxi extends PersistentInCacheProxi implements PersistentNewOrderCommand{
    
    public NewOrderCommandICProxi(long objectId) {
        super(objectId);
    }
    public NewOrderCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theNewOrderCommandFacade
            .getNewOrderCommand(this.getId());
    }
