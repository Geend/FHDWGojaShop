...
public class NewPreOrderCommandICProxi extends PersistentInCacheProxi implements PersistentNewPreOrderCommand{
    
    public NewPreOrderCommandICProxi(long objectId) {
        super(objectId);
    }
    public NewPreOrderCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theNewPreOrderCommandFacade
            .getNewPreOrderCommand(this.getId());
    }
