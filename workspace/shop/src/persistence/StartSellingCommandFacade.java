...
public class StartSellingCommandFacade{
    ...
    public PersistentStartSellingCommand newStartSellingCommand(long idCreateIfLessZero) throws PersistenceException {
        if(idCreateIfLessZero > 0) return (PersistentStartSellingCommand)PersistentProxi.createProxi(idCreateIfLessZero, 274);
        ...
        return (PersistentStartSellingCommand)PersistentProxi.createProxi(id, 274);
    }
    ...
    public long getClass(long objectId) throws PersistenceException{
        if(Cache.getTheCache().contains(objectId, 274)) return 274;
    ...
    public void commandReceiverSet(long StartSellingCommandId, OwnerArticleWrapper4Public commandReceiverVal) throws PersistenceException {
