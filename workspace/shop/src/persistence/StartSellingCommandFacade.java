...
public class StartSellingCommandFacade{
    ...
    public PersistentStartSellingCommand newStartSellingCommand(long idCreateIfLessZero) throws PersistenceException {
        ...
        StartSellingCommand result = new StartSellingCommand(null,null,null,null,id);
    ...
    public void articleSet(long StartSellingCommandId, ArticleWrapper4Public articleVal) throws PersistenceException {
        
    }
    public void invokerSet(long StartSellingCommandId, Invoker invokerVal) throws PersistenceException {
        
    }
    public void commandReceiverSet(long StartSellingCommandId, Shop4Public commandReceiverVal) throws PersistenceException {
