...
public class BackgroundTaskManagerICProxi extends PersistentInCacheProxiOptimistic implements PersistentBackgroundTaskManager{
    
    public BackgroundTaskManagerICProxi(long objectId) {
        super(objectId);
    }
    public BackgroundTaskManagerICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theBackgroundTaskManagerFacade
            .getBackgroundTaskManager(this.getId());
    }
