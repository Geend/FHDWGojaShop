...
public class CustomerServiceComponentManagerFacade{
    ...
    public PersistentCustomerServiceComponentManager newCustomerServiceComponentManager(long idCreateIfLessZero) throws PersistenceException {
        if(idCreateIfLessZero > 0) return (PersistentCustomerServiceComponentManager)PersistentProxi.createProxi(idCreateIfLessZero, 399);
        ...
        return (PersistentCustomerServiceComponentManager)PersistentProxi.createProxi(id, 399);
    }
    ...
    public long getClass(long objectId) throws PersistenceException{
        if(Cache.getTheCache().contains(objectId, 399)) return 399;
