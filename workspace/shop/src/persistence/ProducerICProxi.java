...
public class ProducerICProxi extends PersistentInCacheProxiOptimistic implements PersistentProducer{
    
    public ProducerICProxi(long objectId) {
        super(objectId);
    }
    public ProducerICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theProducerFacade
            .getProducer(this.getId());
    }
