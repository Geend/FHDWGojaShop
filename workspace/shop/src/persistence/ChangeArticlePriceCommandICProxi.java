...
public class ChangeArticlePriceCommandICProxi extends PersistentInCacheProxi implements PersistentChangeArticlePriceCommand{
    
    public ChangeArticlePriceCommandICProxi(long objectId) {
        super(objectId);
    }
    public ChangeArticlePriceCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theChangeArticlePriceCommandFacade
            .getChangeArticlePriceCommand(this.getId());
    }
