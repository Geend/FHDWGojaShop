...
public class DebitCommandProxi extends PersistentProxi implements PersistentDebitCommand{
    
    public DebitCommandProxi(long objectId) {
        super(objectId);
    }
    public DebitCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
