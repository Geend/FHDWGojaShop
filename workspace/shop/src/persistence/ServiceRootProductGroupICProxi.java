...
public class ServiceRootProductGroupICProxi extends PersistentInCacheProxiOptimistic implements PersistentServiceRootProductGroup{
    
    public ServiceRootProductGroupICProxi(long objectId) {
        super(objectId);
    }
    public ServiceRootProductGroupICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theServiceRootProductGroupFacade
            .getServiceRootProductGroup(this.getId());
    }
