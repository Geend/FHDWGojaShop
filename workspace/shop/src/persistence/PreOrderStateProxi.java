...
public class PreOrderStateProxi extends OrderStatusProxi implements PersistentPreOrderState{
    
    public PreOrderStateProxi(long objectId) {
        super(objectId);
    }
    public PreOrderStateProxi(PersistentInCacheProxi object) {
        super(object);
    }
