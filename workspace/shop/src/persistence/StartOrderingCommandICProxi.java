...
public class StartOrderingCommandICProxi extends PersistentInCacheProxi implements PersistentStartOrderingCommand{
    
    public StartOrderingCommandICProxi(long objectId) {
        super(objectId);
    }
    public StartOrderingCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theStartOrderingCommandFacade
            .getStartOrderingCommand(this.getId());
    }
