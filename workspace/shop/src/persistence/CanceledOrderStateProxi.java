...
public class CanceledOrderStateProxi extends OrderStatusProxi implements PersistentCanceledOrderState{
    
    public CanceledOrderStateProxi(long objectId) {
        super(objectId);
    }
    public CanceledOrderStateProxi(PersistentInCacheProxi object) {
        super(object);
    }
