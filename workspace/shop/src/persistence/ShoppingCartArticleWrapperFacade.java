...
public class ShoppingCartArticleWrapperFacade{
    ...
    public PersistentShoppingCartArticleWrapper newShoppingCartArticleWrapper(long idCreateIfLessZero) throws PersistenceException {
        if(idCreateIfLessZero > 0) return (PersistentShoppingCartArticleWrapper)PersistentProxi.createProxi(idCreateIfLessZero, 243);
        ...
        return (PersistentShoppingCartArticleWrapper)PersistentProxi.createProxi(id, 243);
    }
