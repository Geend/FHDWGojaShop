...
public class ProducerLstProxi extends PersistentProxi implements PersistentProducerLst{
    
    public ProducerLstProxi(long objectId) {
        super(objectId);
    }
    public ProducerLstProxi(PersistentInCacheProxi object) {
        super(object);
    }
