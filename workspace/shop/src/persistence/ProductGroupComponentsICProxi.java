...
public class ProductGroupComponentsICProxi extends PersistentInCacheProxiOptimistic implements PersistentProductGroupComponents{
    
    public ProductGroupComponentsICProxi(long objectId) {
        super(objectId);
    }
    public ProductGroupComponentsICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theProductGroupComponentsFacade
            .getProductGroupComponents(this.getId());
    }
