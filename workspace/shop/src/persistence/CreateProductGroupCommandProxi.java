...
public class CreateProductGroupCommandProxi extends PersistentProxi implements PersistentCreateProductGroupCommand{
    
    public CreateProductGroupCommandProxi(long objectId) {
        super(objectId);
    }
    public CreateProductGroupCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
