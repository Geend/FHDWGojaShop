...
public abstract class ComponentWrapperICProxi extends PersistentInCacheProxiOptimistic implements PersistentComponentWrapper{
    
    public ComponentWrapperICProxi(long objectId) {
        super(objectId);
    }
    public ComponentWrapperICProxi(PersistentObject object) {
        super(object);
    }
