...
public class OwnerServiceOrderManagerProxi extends PersistentProxi implements PersistentOwnerServiceOrderManager{
    
    public OwnerServiceOrderManagerProxi(long objectId) {
        super(objectId);
    }
    public OwnerServiceOrderManagerProxi(PersistentInCacheProxi object) {
        super(object);
    }
