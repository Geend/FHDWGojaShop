...
public class ChangeMinStockCommandProxi extends PersistentProxi implements PersistentChangeMinStockCommand{
    
    public ChangeMinStockCommandProxi(long objectId) {
        super(objectId);
    }
    public ChangeMinStockCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
