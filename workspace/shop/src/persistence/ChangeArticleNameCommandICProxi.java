...
public class ChangeArticleNameCommandICProxi extends PersistentInCacheProxi implements PersistentChangeArticleNameCommand{
    
    public ChangeArticleNameCommandICProxi(long objectId) {
        super(objectId);
    }
    public ChangeArticleNameCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theChangeArticleNameCommandFacade
            .getChangeArticleNameCommand(this.getId());
    }
