...
public class CreateSubProductGroupCommandProxi extends PersistentProxi implements PersistentCreateSubProductGroupCommand{
    
    public CreateSubProductGroupCommandProxi(long objectId) {
        super(objectId);
    }
    public CreateSubProductGroupCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
