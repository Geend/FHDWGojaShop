...
public class OwnerServiceReOrderManagerProxi extends PersistentProxi implements PersistentOwnerServiceReOrderManager{
    
    public OwnerServiceReOrderManagerProxi(long objectId) {
        super(objectId);
    }
    public OwnerServiceReOrderManagerProxi(PersistentInCacheProxi object) {
        super(object);
    }
