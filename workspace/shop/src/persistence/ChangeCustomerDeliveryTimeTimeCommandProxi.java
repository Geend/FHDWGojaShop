...
public class ChangeCustomerDeliveryTimeTimeCommandProxi extends PersistentProxi implements PersistentChangeCustomerDeliveryTimeTimeCommand{
    
    public ChangeCustomerDeliveryTimeTimeCommandProxi(long objectId) {
        super(objectId);
    }
    public ChangeCustomerDeliveryTimeTimeCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
