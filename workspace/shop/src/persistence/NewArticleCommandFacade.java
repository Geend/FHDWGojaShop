...
public class NewArticleCommandFacade{
    ...
    public PersistentNewArticleCommand newNewArticleCommand(String name,common.Fraction price,long minStock,long maxStock,long producerDeliveryTime,long idCreateIfLessZero) throws PersistenceException {
        ...
        NewArticleCommand result = new NewArticleCommand(null,name,price,minStock,maxStock,producerDeliveryTime,null,null,null,null,null,id);
    ...
    public void parentSet(long NewArticleCommandId, ComponentContainer parentVal) throws PersistenceException {
    ...
    public void commandReceiverSet(long NewArticleCommandId, Shop4Public commandReceiverVal) throws PersistenceException {
