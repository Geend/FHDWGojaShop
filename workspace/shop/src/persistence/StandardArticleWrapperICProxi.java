...
public class StandardArticleWrapperICProxi extends ArticleWrapperICProxi implements PersistentStandardArticleWrapper{
    
    public StandardArticleWrapperICProxi(long objectId) {
        super(objectId);
    }
    public StandardArticleWrapperICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theStandardArticleWrapperFacade
            .getStandardArticleWrapper(this.getId());
    }
