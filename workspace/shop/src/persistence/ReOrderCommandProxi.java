...
public class ReOrderCommandProxi extends PersistentProxi implements PersistentReOrderCommand{
    
    public ReOrderCommandProxi(long objectId) {
        super(objectId);
    }
    public ReOrderCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
