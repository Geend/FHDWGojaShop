...
public class IncreaseStockCommandFacade{
    ...
    public PersistentIncreaseStockCommand newIncreaseStockCommand(long quantity,long idCreateIfLessZero) throws PersistenceException {
        if(idCreateIfLessZero > 0) return (PersistentIncreaseStockCommand)PersistentProxi.createProxi(idCreateIfLessZero, 222);
        ...
        return (PersistentIncreaseStockCommand)PersistentProxi.createProxi(id, 222);
    }
    ...
    public void commandReceiverSet(long IncreaseStockCommandId, OwnerArticleWrapper4Public commandReceiverVal) throws PersistenceException {
