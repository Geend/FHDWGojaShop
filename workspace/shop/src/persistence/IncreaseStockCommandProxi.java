...
public class IncreaseStockCommandProxi extends PersistentProxi implements PersistentIncreaseStockCommand{
    
    public IncreaseStockCommandProxi(long objectId) {
        super(objectId);
    }
    public IncreaseStockCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
