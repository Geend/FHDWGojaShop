...
public class ServerRootProductGroupICProxi extends PersistentInCacheProxiOptimistic implements PersistentServerRootProductGroup{
    
    public ServerRootProductGroupICProxi(long objectId) {
        super(objectId);
    }
    public ServerRootProductGroupICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theServerRootProductGroupFacade
            .getServerRootProductGroup(this.getId());
    }
