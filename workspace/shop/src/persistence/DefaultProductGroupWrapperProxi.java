...
public class DefaultProductGroupWrapperProxi extends ProductGroupWrapperProxi implements PersistentDefaultProductGroupWrapper{
    
    public DefaultProductGroupWrapperProxi(long objectId) {
        super(objectId);
    }
    public DefaultProductGroupWrapperProxi(PersistentInCacheProxi object) {
        super(object);
    }
