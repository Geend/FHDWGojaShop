...
public class OrderQuantifiedArticleMarkedForReturnStateProxi extends OrderQuantifiedArticleStateProxi implements PersistentOrderQuantifiedArticleMarkedForReturnState{
    
    public OrderQuantifiedArticleMarkedForReturnStateProxi(long objectId) {
        super(objectId);
    }
    public OrderQuantifiedArticleMarkedForReturnStateProxi(PersistentInCacheProxi object) {
        super(object);
    }
