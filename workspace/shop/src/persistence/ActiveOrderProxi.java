...
public class ActiveOrderProxi extends OrderStateProxi implements PersistentActiveOrder{
    
    public ActiveOrderProxi(long objectId) {
        super(objectId);
    }
    public ActiveOrderProxi(PersistentInCacheProxi object) {
        super(object);
    }
