...
public class RootProductGroupProxi extends ProductGroupProxi implements PersistentRootProductGroup{
    
    public RootProductGroupProxi(long objectId) {
        super(objectId);
    }
    public RootProductGroupProxi(PersistentInCacheProxi object) {
        super(object);
    }
