...
public class ChangeCustomerDeliveryTimePriceCommandICProxi extends PersistentInCacheProxi implements PersistentChangeCustomerDeliveryTimePriceCommand{
    
    public ChangeCustomerDeliveryTimePriceCommandICProxi(long objectId) {
        super(objectId);
    }
    public ChangeCustomerDeliveryTimePriceCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theChangeCustomerDeliveryTimePriceCommandFacade
            .getChangeCustomerDeliveryTimePriceCommand(this.getId());
    }
