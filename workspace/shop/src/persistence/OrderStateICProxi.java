...
public abstract class OrderStateICProxi extends PersistentInCacheProxiOptimistic implements PersistentOrderState{
    
    public OrderStateICProxi(long objectId) {
        super(objectId);
    }
    public OrderStateICProxi(PersistentObject object) {
        super(object);
    }
