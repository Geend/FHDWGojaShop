...
public class CustomerServiceRootProductGroupProxi extends PersistentProxi implements PersistentCustomerServiceRootProductGroup{
    
    public CustomerServiceRootProductGroupProxi(long objectId) {
        super(objectId);
    }
    public CustomerServiceRootProductGroupProxi(PersistentInCacheProxi object) {
        super(object);
    }
