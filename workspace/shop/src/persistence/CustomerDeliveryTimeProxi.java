...
public class CustomerDeliveryTimeProxi extends PersistentProxi implements PersistentCustomerDeliveryTime{
    
    public CustomerDeliveryTimeProxi(long objectId) {
        super(objectId);
    }
    public CustomerDeliveryTimeProxi(PersistentInCacheProxi object) {
        super(object);
    }
