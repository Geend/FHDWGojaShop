...
public class ReOrderQuantifiedArticleProxi extends QuantifiedArticleProxi implements PersistentReOrderQuantifiedArticle{
    
    public ReOrderQuantifiedArticleProxi(long objectId) {
        super(objectId);
    }
    public ReOrderQuantifiedArticleProxi(PersistentInCacheProxi object) {
        super(object);
    }
