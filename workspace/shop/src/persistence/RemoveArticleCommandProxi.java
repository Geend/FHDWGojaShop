...
public class RemoveArticleCommandProxi extends PersistentProxi implements PersistentRemoveArticleCommand{
    
    public RemoveArticleCommandProxi(long objectId) {
        super(objectId);
    }
    public RemoveArticleCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
