...
public class ProductGroupComponentsFacade{
    ...
    public PersistentProductGroupComponents newProductGroupComponents(long idCreateIfLessZero) throws PersistenceException {
        if(idCreateIfLessZero > 0) return (PersistentProductGroupComponents)PersistentProxi.createProxi(idCreateIfLessZero, 391);
        ...
        return (PersistentProductGroupComponents)PersistentProxi.createProxi(id, 391);
    }
    ...
    public long getClass(long objectId) throws PersistenceException{
        if(Cache.getTheCache().contains(objectId, 391)) return 391;
