...
public class AddSubProductGroupCommandICProxi extends PersistentInCacheProxi implements PersistentAddSubProductGroupCommand{
    
    public AddSubProductGroupCommandICProxi(long objectId) {
        super(objectId);
    }
    public AddSubProductGroupCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theAddSubProductGroupCommandFacade
            .getAddSubProductGroupCommand(this.getId());
    }
