...
public class PreOrderCartCommandProxi extends PersistentProxi implements PersistentPreOrderCartCommand{
    
    public PreOrderCartCommandProxi(long objectId) {
        super(objectId);
    }
    public PreOrderCartCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
