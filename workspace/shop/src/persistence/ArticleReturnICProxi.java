...
public class ArticleReturnICProxi extends PersistentInCacheProxiOptimistic implements PersistentArticleReturn{
    
    public ArticleReturnICProxi(long objectId) {
        super(objectId);
    }
    public ArticleReturnICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theArticleReturnFacade
            .getArticleReturn(this.getId());
    }
