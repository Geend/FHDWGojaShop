...
public class ReturnManagerICProxi extends PersistentInCacheProxiOptimistic implements PersistentReturnManager{
    
    public ReturnManagerICProxi(long objectId) {
        super(objectId);
    }
    public ReturnManagerICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theReturnManagerFacade
            .getReturnManager(this.getId());
    }
