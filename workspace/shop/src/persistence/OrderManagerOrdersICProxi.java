...
public class OrderManagerOrdersICProxi extends PersistentInCacheProxiOptimistic implements PersistentOrderManagerOrders{
    
    public OrderManagerOrdersICProxi(long objectId) {
        super(objectId);
    }
    public OrderManagerOrdersICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theOrderManagerOrdersFacade
            .getOrderManagerOrders(this.getId());
    }
