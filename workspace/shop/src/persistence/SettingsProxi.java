...
public class SettingsProxi extends PersistentProxi implements PersistentSettings{
    
    public SettingsProxi(long objectId) {
        super(objectId);
    }
    public SettingsProxi(PersistentInCacheProxi object) {
        super(object);
    }
