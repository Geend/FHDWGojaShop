...
public class ReOrderForPreorderCommandProxi extends PersistentProxi implements PersistentReOrderForPreorderCommand{
    
    public ReOrderForPreorderCommandProxi(long objectId) {
        super(objectId);
    }
    public ReOrderForPreorderCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
