...
public class ReOrderManagerReorderArticlesProxi extends PersistentProxi implements PersistentReOrderManagerReorderArticles{
    
    public ReOrderManagerReorderArticlesProxi(long objectId) {
        super(objectId);
    }
    public ReOrderManagerReorderArticlesProxi(PersistentInCacheProxi object) {
        super(object);
    }
