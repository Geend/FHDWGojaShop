...
public abstract class ProductGroupWrapperProxi extends ComponentWrapperProxi implements PersistentProductGroupWrapper{
    
    public ProductGroupWrapperProxi(long objectId) {
        super(objectId);
    }
    public ProductGroupWrapperProxi(PersistentInCacheProxi object) {
        super(object);
    }
