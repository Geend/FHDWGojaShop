...
public abstract class OrderQuantifiedArticleStateICProxi extends PersistentInCacheProxiOptimistic implements PersistentOrderQuantifiedArticleState{
    
    public OrderQuantifiedArticleStateICProxi(long objectId) {
        super(objectId);
    }
    public OrderQuantifiedArticleStateICProxi(PersistentObject object) {
        super(object);
    }
