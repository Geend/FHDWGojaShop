...
public class CreateArticleCommandICProxi extends PersistentInCacheProxi implements PersistentCreateArticleCommand{
    
    public CreateArticleCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateArticleCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theCreateArticleCommandFacade
            .getCreateArticleCommand(this.getId());
    }
