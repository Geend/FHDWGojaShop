...
public class OrderQuantifiedArticleNormalStateProxi extends OrderQuantifiedArticleStateProxi implements PersistentOrderQuantifiedArticleNormalState{
    
    public OrderQuantifiedArticleNormalStateProxi(long objectId) {
        super(objectId);
    }
    public OrderQuantifiedArticleNormalStateProxi(PersistentInCacheProxi object) {
        super(object);
    }
