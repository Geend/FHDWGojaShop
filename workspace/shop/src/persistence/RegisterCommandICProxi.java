...
public class RegisterCommandICProxi extends PersistentInCacheProxi implements PersistentRegisterCommand{
    
    public RegisterCommandICProxi(long objectId) {
        super(objectId);
    }
    public RegisterCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theRegisterCommandFacade
            .getRegisterCommand(this.getId());
    }
