...
public class CustomerArticleLstICProxi extends PersistentInCacheProxiOptimistic implements PersistentCustomerArticleLst{
    
    public CustomerArticleLstICProxi(long objectId) {
        super(objectId);
    }
    public CustomerArticleLstICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theCustomerArticleLstFacade
            .getCustomerArticleLst(this.getId());
    }
