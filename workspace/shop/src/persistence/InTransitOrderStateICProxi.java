...
public class InTransitOrderStateICProxi extends OrderStatusICProxi implements PersistentInTransitOrderState{
    
    public InTransitOrderStateICProxi(long objectId) {
        super(objectId);
    }
    public InTransitOrderStateICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theInTransitOrderStateFacade
            .getInTransitOrderState(this.getId());
    }
