...
public class FinishedOrderStateProxi extends OrderStatusProxi implements PersistentFinishedOrderState{
    
    public FinishedOrderStateProxi(long objectId) {
        super(objectId);
    }
    public FinishedOrderStateProxi(PersistentInCacheProxi object) {
        super(object);
    }
