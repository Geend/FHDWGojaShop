...
public class OwnerArticleWrapperProxi extends ArticleWrapperProxi implements PersistentOwnerArticleWrapper{
    
    public OwnerArticleWrapperProxi(long objectId) {
        super(objectId);
    }
    public OwnerArticleWrapperProxi(PersistentInCacheProxi object) {
        super(object);
    }
