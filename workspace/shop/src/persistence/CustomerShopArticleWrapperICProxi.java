...
public class CustomerShopArticleWrapperICProxi extends ArticleWrapperICProxi implements PersistentCustomerShopArticleWrapper{
    
    public CustomerShopArticleWrapperICProxi(long objectId) {
        super(objectId);
    }
    public CustomerShopArticleWrapperICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theCustomerShopArticleWrapperFacade
            .getCustomerShopArticleWrapper(this.getId());
    }
