...
public class CustomerRegisterServiceICProxi extends ServiceICProxi implements PersistentCustomerRegisterService{
    
    public CustomerRegisterServiceICProxi(long objectId) {
        super(objectId);
    }
    public CustomerRegisterServiceICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theCustomerRegisterServiceFacade
            .getCustomerRegisterService(this.getId());
    }
