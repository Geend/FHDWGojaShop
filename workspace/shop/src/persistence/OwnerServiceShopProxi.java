...
public class OwnerServiceShopProxi extends PersistentProxi implements PersistentOwnerServiceShop{
    
    public OwnerServiceShopProxi(long objectId) {
        super(objectId);
    }
    public OwnerServiceShopProxi(PersistentInCacheProxi object) {
        super(object);
    }
