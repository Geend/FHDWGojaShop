...
public class SubProductGroupICProxi extends ProductGroupICProxi implements PersistentSubProductGroup{
    
    public SubProductGroupICProxi(long objectId) {
        super(objectId);
    }
    public SubProductGroupICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theSubProductGroupFacade
            .getSubProductGroup(this.getId());
    }
