...
public class CreateProducerCommandProxi extends PersistentProxi implements PersistentCreateProducerCommand{
    
    public CreateProducerCommandProxi(long objectId) {
        super(objectId);
    }
    public CreateProducerCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
