...
public class GlobalOrderManagerProxi extends OrderManagerProxi implements PersistentGlobalOrderManager{
    
    public GlobalOrderManagerProxi(long objectId) {
        super(objectId);
    }
    public GlobalOrderManagerProxi(PersistentInCacheProxi object) {
        super(object);
    }
