...
public class ChangeArticleQuantityCommandProxi extends PersistentProxi implements PersistentChangeArticleQuantityCommand{
    
    public ChangeArticleQuantityCommandProxi(long objectId) {
        super(objectId);
    }
    public ChangeArticleQuantityCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
