...
public class CancelPreOrderCommandProxi extends PersistentProxi implements PersistentCancelPreOrderCommand{
    
    public CancelPreOrderCommandProxi(long objectId) {
        super(objectId);
    }
    public CancelPreOrderCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
