...
public class NewSubProductGroupCommandICProxi extends PersistentInCacheProxi implements PersistentNewSubProductGroupCommand{
    
    public NewSubProductGroupCommandICProxi(long objectId) {
        super(objectId);
    }
    public NewSubProductGroupCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theNewSubProductGroupCommandFacade
            .getNewSubProductGroupCommand(this.getId());
    }
