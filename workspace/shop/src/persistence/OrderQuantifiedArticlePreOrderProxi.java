...
public class OrderQuantifiedArticlePreOrderProxi extends OrderQuantifiedArticleStateProxi implements PersistentOrderQuantifiedArticlePreOrder{
    
    public OrderQuantifiedArticlePreOrderProxi(long objectId) {
        super(objectId);
    }
    public OrderQuantifiedArticlePreOrderProxi(PersistentInCacheProxi object) {
        super(object);
    }
