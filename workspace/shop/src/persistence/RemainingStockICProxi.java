...
public class RemainingStockICProxi extends ArticleStateICProxi implements PersistentRemainingStock{
    
    public RemainingStockICProxi(long objectId) {
        super(objectId);
    }
    public RemainingStockICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theRemainingStockFacade
            .getRemainingStock(this.getId());
    }
