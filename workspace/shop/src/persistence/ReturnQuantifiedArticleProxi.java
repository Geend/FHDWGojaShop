...
public class ReturnQuantifiedArticleProxi extends QuantifiedArticleProxi implements PersistentReturnQuantifiedArticle{
    
    public ReturnQuantifiedArticleProxi(long objectId) {
        super(objectId);
    }
    public ReturnQuantifiedArticleProxi(PersistentInCacheProxi object) {
        super(object);
    }
