...
public class CustomerDeliveryTimeManagerProxi extends PersistentProxi implements PersistentCustomerDeliveryTimeManager{
    
    public CustomerDeliveryTimeManagerProxi(long objectId) {
        super(objectId);
    }
    public CustomerDeliveryTimeManagerProxi(PersistentInCacheProxi object) {
        super(object);
    }
