...
public class ShoppingCartQuantifiedArticleICProxi extends QuantifiedArticleICProxi implements PersistentShoppingCartQuantifiedArticle{
    
    public ShoppingCartQuantifiedArticleICProxi(long objectId) {
        super(objectId);
    }
    public ShoppingCartQuantifiedArticleICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theShoppingCartQuantifiedArticleFacade
            .getShoppingCartQuantifiedArticle(this.getId());
    }
