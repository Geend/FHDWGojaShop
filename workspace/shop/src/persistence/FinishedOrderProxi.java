...
public class FinishedOrderProxi extends OrderStateProxi implements PersistentFinishedOrder{
    
    public FinishedOrderProxi(long objectId) {
        super(objectId);
    }
    public FinishedOrderProxi(PersistentInCacheProxi object) {
        super(object);
    }
