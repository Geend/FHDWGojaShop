...
public class ReduceStockCommandFacade{
    ...
    public PersistentReduceStockCommand newReduceStockCommand(long quantity,long idCreateIfLessZero) throws PersistenceException {
        if(idCreateIfLessZero > 0) return (PersistentReduceStockCommand)PersistentProxi.createProxi(idCreateIfLessZero, 220);
        ...
        return (PersistentReduceStockCommand)PersistentProxi.createProxi(id, 220);
    }
    ...
    public void commandReceiverSet(long ReduceStockCommandId, OwnerArticleWrapper4Public commandReceiverVal) throws PersistenceException {
