...
public class OrderCartCommandProxi extends PersistentProxi implements PersistentOrderCartCommand{
    
    public OrderCartCommandProxi(long objectId) {
        super(objectId);
    }
    public OrderCartCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
