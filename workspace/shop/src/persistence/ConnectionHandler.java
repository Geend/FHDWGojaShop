...
//			oracleConnection.setImplicitCachingEnabled(true);
			...
			callable.execute();
			callable.close();
            this.theProducerLstFacade= new ProducerLstFacade(this.schemaName, this.con);
            ...
            this.theCreateProductGroupCommandFacade= new CreateProductGroupCommandFacade(this.schemaName, this.con);
            this.theCreateProducerCommandFacade= new CreateProducerCommandFacade(this.schemaName, this.con);
            ...
            this.theAddSubProductGroupCommandFacade= new AddSubProductGroupCommandFacade(this.schemaName, this.con);
            ...
            this.theAddArticleCommandFacade= new AddArticleCommandFacade(this.schemaName, this.con);
