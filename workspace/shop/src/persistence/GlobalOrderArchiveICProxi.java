...
public class GlobalOrderArchiveICProxi extends PersistentInCacheProxiOptimistic implements PersistentGlobalOrderArchive{
    
    public GlobalOrderArchiveICProxi(long objectId) {
        super(objectId);
    }
    public GlobalOrderArchiveICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theGlobalOrderArchiveFacade
            .getGlobalOrderArchive(this.getId());
    }
