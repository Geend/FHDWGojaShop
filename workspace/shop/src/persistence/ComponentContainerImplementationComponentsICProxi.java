...
public class ComponentContainerImplementationComponentsICProxi extends PersistentInCacheProxiOptimistic implements PersistentComponentContainerImplementationComponents{
    
    public ComponentContainerImplementationComponentsICProxi(long objectId) {
        super(objectId);
    }
    public ComponentContainerImplementationComponentsICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theComponentContainerImplementationComponentsFacade
            .getComponentContainerImplementationComponents(this.getId());
    }
