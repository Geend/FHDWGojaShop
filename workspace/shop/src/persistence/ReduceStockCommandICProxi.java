...
public class ReduceStockCommandICProxi extends PersistentInCacheProxi implements PersistentReduceStockCommand{
    
    public ReduceStockCommandICProxi(long objectId) {
        super(objectId);
    }
    public ReduceStockCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theReduceStockCommandFacade
            .getReduceStockCommand(this.getId());
    }
