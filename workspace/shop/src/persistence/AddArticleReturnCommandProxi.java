...
public class AddArticleReturnCommandProxi extends PersistentProxi implements PersistentAddArticleReturnCommand{
    
    public AddArticleReturnCommandProxi(long objectId) {
        super(objectId);
    }
    public AddArticleReturnCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
