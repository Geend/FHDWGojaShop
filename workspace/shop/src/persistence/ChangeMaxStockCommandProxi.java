...
public class ChangeMaxStockCommandProxi extends PersistentProxi implements PersistentChangeMaxStockCommand{
    
    public ChangeMaxStockCommandProxi(long objectId) {
        super(objectId);
    }
    public ChangeMaxStockCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
