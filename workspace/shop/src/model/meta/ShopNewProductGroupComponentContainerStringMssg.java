...
public class ShopNewProductGroupComponentContainerStringMssg implements ShopDOWNMssgs,ShopUPMssgs{
    ...
    public synchronized persistence.ProductGroup4Public getResult() throws model.DoubleDefinitionException, model.InvalidInputException, model.CycleException, PersistenceException {
        if(this.excptn != null) {
