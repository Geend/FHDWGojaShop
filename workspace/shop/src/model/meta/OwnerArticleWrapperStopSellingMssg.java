...
public class OwnerArticleWrapperStopSellingMssg implements OwnerArticleWrapperDOWNMssgs,OwnerArticleWrapperUPMssgs{
    
    private java.util.Date exctDte = null;
    private Exception excptn;
    public final persistence.PersistentOwnerArticleWrapper rcvr;
    
    public OwnerArticleWrapperStopSellingMssg(persistence.PersistentOwnerArticleWrapper rcvr){
        this.rcvr = rcvr;
    }
    public void accept(OwnerArticleWrapperMssgsVisitor visitor) throws PersistenceException{
        visitor.handleOwnerArticleWrapperStopSellingMssg(this);
    }
