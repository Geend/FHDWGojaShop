...
public class ShopOrderCartCustomerOrderManagerShoppingCartCustomerDeliveryTimeMssg implements ShopDOWNMssgs,ShopUPMssgs{
    ...
    public ShopOrderCartCustomerOrderManagerShoppingCartCustomerDeliveryTimeMssg(persistence.CustomerOrderManager4Public manager,
    ...
    public void accept(ShopMssgsVisitor visitor) throws PersistenceException{
        visitor.handleShopOrderCartCustomerOrderManagerShoppingCartCustomerDeliveryTimeMssg(this);
    }
    public synchronized void execute() {
        if (this.exctDte == null){
            this.exctDte = new java.util.Date();
            try{
                this.rcvr.orderCartImplementation(this.manager, this.cart, this.customerDeliveryTime);
