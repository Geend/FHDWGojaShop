...
public class ChangeArticleNameCommand extends PersistentObject implements PersistentChangeArticleNameCommand{
    ...
    public ChangeArticleNameCommand(String newName,Invoker invoker,PersistentArticleWrapper commandReceiver,PersistentCommonDate myCommonDate,long id) throws PersistenceException {
    ...
    public void store() throws PersistenceException {
        ...
        if (this.getClassId() == 290) ConnectionHandler.getTheConnectionHandler().theChangeArticleNameCommandFacade
    ...
    public void execute() 
        ...
        this.commandReceiver.changeArticleName(this.getNewName());
