...
public class ShopChangeMinStockArticleWrapperIntegerMssg implements ShopDOWNMssgs,ShopUPMssgs{
    ...
    public ShopChangeMinStockArticleWrapperIntegerMssg(persistence.ArticleWrapper4Public article,
                                                       long newValue,
    ...
    public void accept(ShopMssgsVisitor visitor) throws PersistenceException{
        visitor.handleShopChangeMinStockArticleWrapperIntegerMssg(this);
    }
    public synchronized void execute() {
        if (this.exctDte == null){
            this.exctDte = new java.util.Date();
            try{
                this.rcvr.changeMinStockImplementation(this.article, this.newValue);
