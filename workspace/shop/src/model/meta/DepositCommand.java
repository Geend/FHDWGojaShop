...
public class DepositCommand extends PersistentObject implements PersistentDepositCommand{
    ...
    public static DepositCommand4Public getById(long objectId) throws PersistenceException{
        long classId = ConnectionHandler.getTheConnectionHandler().theDepositCommandFacade.getClass(objectId);
        return (DepositCommand4Public)PersistentProxi.createProxi(objectId, classId);
    }
    
    public static DepositCommand4Public createDepositCommand(common.Fraction amount,java.sql.Date createDate,java.sql.Date commitDate) throws PersistenceException{
        return createDepositCommand(amount,createDate,commitDate,false);
    }
    
    public static DepositCommand4Public createDepositCommand(common.Fraction amount,java.sql.Date createDate,java.sql.Date commitDate,boolean delayed$Persistence) throws PersistenceException {
        ...
        ((PersistentDepositCommand)result).setMyCommonDate(CommonDate.createCommonDate(createDate, createDate));
        return result;
    }
    ...
    public DepositCommand(common.Fraction amount,Invoker invoker,PersistentCustomerAccount commandReceiver,PersistentCommonDate myCommonDate,long id) throws PersistenceException {
    ...
    public void store() throws PersistenceException {
        ...
        if (this.getClassId() == 300) ConnectionHandler.getTheConnectionHandler().theDepositCommandFacade
