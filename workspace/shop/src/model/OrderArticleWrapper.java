...
public class OrderArticleWrapper extends model.ArticleWrapper implements PersistentOrderArticleWrapper{
    ...
    public static OrderArticleWrapper4Public createOrderArticleWrapper() throws PersistenceException{
        return createOrderArticleWrapper(false);
    }
    
    public static OrderArticleWrapper4Public createOrderArticleWrapper(boolean delayed$Persistence) throws PersistenceException {
    ...
    public static OrderArticleWrapper4Public createOrderArticleWrapper(boolean delayed$Persistence,OrderArticleWrapper4Public This) throws PersistenceException {
        PersistentOrderArticleWrapper result = null;
        if(delayed$Persistence){
            result = ConnectionHandler.getTheConnectionHandler().theOrderArticleWrapperFacade
                .newDelayedOrderArticleWrapper(common.Fraction.Null);
    ...
    public void store() throws PersistenceException {
        ...
        if (this.getClassId() == 231) ConnectionHandler.getTheConnectionHandler().theOrderArticleWrapperFacade
