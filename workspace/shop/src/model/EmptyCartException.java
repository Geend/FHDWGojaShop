...
public class EmptyCartException extends model.UserException{
    ...
    public EmptyCartException(String message) throws PersistenceException {
        super(message);        
    }
    ...
    public EmptyCartException() throws PersistenceException {
