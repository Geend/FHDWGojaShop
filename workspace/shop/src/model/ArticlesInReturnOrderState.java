...
public class ArticlesInReturnOrderState extends model.OrderState implements PersistentArticlesInReturnOrderState{
    ...
    public ArticlesInReturnOrderState(SubjInterface subService,PersistentOrderState This,long ticksLeft,long id) throws PersistenceException {
